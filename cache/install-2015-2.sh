...
# Install NVM and use it to install Node.js 0.12
...
# Move the Node.js 0.12 interface file into the correct place
#  Assumes that Cache was installedd into /opt/cache
#  Modify path as appropriate

sudo cp /opt/cache/bin/cache0120.node ~/ewdjs/node_modules/cache.node
